...
import { GameTitleComponent } from './view/game-title/game-title.component';
...
@NgModule({
  declarations: [AppComponent, GameViewComponent, GameTitleComponent, WithGameStateComponent],
